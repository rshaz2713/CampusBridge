...
urlpatterns = [
    ...
    path("financial-docs/", student_financial_docs_view, name="student_financial_docs"),
    path("employee-financial-docs/", employee_financial_docs_view, name="employee_financial_docs"),
